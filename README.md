...
III. Spearman Loss/оптимизация неравенства треугольника
...
II. Верно ли, что для любой матрицы близостей найдется такая константа, которая при добавлении делает матрицу метрической
